...
RUN PYTHONDONTWRITEBYTECODE=1 uv pip install --system --no-cache-dir -c /api/constraints.txt -r /deps/__outer_Deployment/src/requirements.txt
# -- End of local requirements install --

# -- Adding non-package dependency Deployment --
...
# -- End of non-package dependency Deployment --

# -- Installing all local dependencies --
RUN PYTHONDONTWRITEBYTECODE=1 uv pip install --system --no-cache-dir -c /api/constraints.txt -e /deps/*
# -- End of local dependencies install --
ENV LANGSERVE_GRAPHS='{"research_assistant": "/deps/__outer_Deployment/src/research_assistant.py:graph"}'
